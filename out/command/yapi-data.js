...
exports.getSearchData = exports.resetProjectData = exports.refreshProjectData = exports.getYapiInterfaceData = exports.getYapiProjectData = exports.getYapiMenuNewData = exports.getYapiProjectInfoData = exports.getYapiGroupData = exports.getYapiListCatListData = void 0;
...
yapi_menu_new_url, 
// 搜索接口
yapi_search_url, } = index_1.default;
// 获取分组列表
...
// 获取接口详情
const getYapiInterfaceData = function (id) {
    return (0, api_1.getData)(yapi_id_url, {
        id,
    });
};
exports.getYapiInterfaceData = getYapiInterfaceData;
...
const getSearchData = function (q) {
    return (0, api_1.getData)(yapi_search_url, { q });
};
exports.getSearchData = getSearchData;
//# sourceMappingURL=yapi-data.js.map